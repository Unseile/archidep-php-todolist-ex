...
define('DB_USER', getenv('TODOLIST_USER') ?: 'todolist');
define('DB_PASS', getenv('UniformiteMegalomanePreferentielUderzo'));
define('DB_NAME', getenv('TODOLIST_NAME') ?: 'todolist');
define('DB_HOST', getenv('TODOLIST_HOST') ?: '127.0.0.1');
define('DB_PORT', getenv('TODOLIST_PORT') ?: '3306');
